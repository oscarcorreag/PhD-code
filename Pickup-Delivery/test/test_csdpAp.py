...
class TestCsdpAp(TestCase):
    def test_solve(self):
        ...
        self.assertAlmostEquals(cost, 76.67734175872316, 2)
        # --------------------------------------------------------------------------------------------------------------
        ...
        self.assertAlmostEquals(cost, 79.47452983542641, 2)
        # --------------------------------------------------------------------------------------------------------------
        ...
        self.assertAlmostEquals(cost, 81.90005783697409, 2)

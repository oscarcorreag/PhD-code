...
class TestCsdpAp(TestCase):
    ...
    def test_solve(self):
        ...
        self.assertAlmostEqual(cost, 11.849696970113953, 2)
        ...
        self.assertAlmostEquals(cost, 27.228044143896327, 2)
        # --------------------------------------------------------------------------------------------------------------
        ...
        self.assertAlmostEquals(cost, 31.646725311077475, 2)
        # --------------------------------------------------------------------------------------------------------------
        ...
        self.assertAlmostEquals(cost, 31.804227315945674, 2)

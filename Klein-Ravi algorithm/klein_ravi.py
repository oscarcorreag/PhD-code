...
class KleinRavi:
    def __init__(self, graph, terminals):
        ...
        # An node-weighted edge-weighted graph is represented by a dictionary with entries ->
        # node: (node_weight, adj_nodes)
        # adj_nodes: dictionary with entries ->  adjacent_node: edge_weight
        self.__graph = graph
    ...
    '''
    Evaluate ratio according to Klein and Ravi paper.
    '''
    ...
    '''
    Get the best node, i.e. the node with the minimum ratio.
    '''
